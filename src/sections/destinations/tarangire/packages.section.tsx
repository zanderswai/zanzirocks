...
const PACKAGES: TgrPackage[] = [
  {
    ...
    highlights: ["Tarangire's legendary elephant herds", "Full-day Ngorongoro Crater descent", "Lake Manyara tree-climbing lions"],
  },
  {
    ...
    highlights: ["Private Land Cruiser — window seat guaranteed", "Tarangire → Serengeti → Ngorongoro", "Baobab groves + Maasai village visit"],
  },
  {
  ...
  },
  {
    ...
    highlights: ["Full northern circuit including Tarangire", "Ngorongoro: lion, leopard, rhino in one day", "Bonus Zanzibar Stone Town night"],
  },
];

function PackageCard({ pkg }: { pkg: TgrPackage }) {
  return (
    <Link
...
export default function TarangirePackagesSection() {
  return (
    <section className="mb-32 md:mb-48">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-12">
        <div>
          ...
          >
            Packages Featuring Tarangire
          </Badge>
          <h2 className="font-headline text-4xl md:text-5xl leading-tight">
            The Elephants Are{" "}
            <span className="italic text-primary">Waiting.</span>
          </h2>
        </div>
        <Button
          asChild
